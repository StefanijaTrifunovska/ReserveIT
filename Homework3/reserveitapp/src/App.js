        ...
        <div className="landing-container">
            <div className="main-section">
                ...
                <div className="main-btns">
                    <Link to="/signup" className="startNow-btn whiteText medium-text">Start now <img src="img/Arrow-right.svg" alt="arrow"></img></Link>
            ...
            <img className="main-illustration" src="img/main-illustration.svg" alt="Illustration"></img>
        </div>
